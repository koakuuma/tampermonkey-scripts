...
${isProd ? '// @downloadURL https://github.com/koakuuma/tampermonkey-scripts/raw/main/dist/gateway-auto-login.user.js' : ''}
${isProd ? '// @updateURL https://github.com/koakuuma/tampermonkey-scripts/raw/main/dist/gateway-auto-login.user.js' : ''}
// ==/UserScript==
`;